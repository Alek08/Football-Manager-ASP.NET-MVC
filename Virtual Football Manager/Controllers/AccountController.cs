...
namespace Virtual_Football_Manager.Controllers
{
    ...
    {
        private ApplicationDbContext db = new ApplicationDbContext();//moe dodadeno
        ...
        public ActionResult AddUserToRole()
        {
            ...
            model.roles = new List<string>() { RoleNames.ADMIN, RoleNames.USER };
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //moj kod za pri register da se dodade virtual team na user
                //MyVirtualTeam myVirtualTeam = new MyVirtualTeam();
                //myVirtualTeam.teamName = "";
                //myVirtualTeam.user = user;
                ...
                if (result.Succeeded)
                {
                    ...
                    //moj kod
                    //na register se dobiva role User
